...
<section>
  ...
  <el-table :data="applications" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
    ...
    <el-table-column prop="name" label="应用名称" width="140" sortable>
    </el-table-column>
    <el-table-column prop="version" label="版本" min-width="100" sortable>
    </el-table-column>
    <el-table-column prop="port_number" label="端口号" width="100" sortable>
    </el-table-column>
    <el-table-column prop="note" label="描述" min-width="220" sortable>
    </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getApplications() {
                ...
                getApplicationListPage(para).then((res) => {
