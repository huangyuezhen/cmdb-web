<template>
	<section>
		...
		<el-table :data="applications" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
			...
			<el-table-column prop="name" label="业务组名称" width="220" sortable>
			</el-table-column>
			<el-table-column prop="version" label="版本" min-width="180" sortable>
			</el-table-column>
			<el-table-column prop="port_number" label="端口号" width="190" sortable>
			</el-table-column>
			<el-table-column prop="start_up" label="启动类型" min-width="180" sortable>
			</el-table-column>
			<el-table-column prop="deploy_path" label="部署路径" min-width="180" sortable>
			</el-table-column>
			<el-table-column prop="application_type" label="应用类型" width="150"
    ...
    export default {
        ...
        methods: {
            ...
            getApplications() {
                ...
                getBusinessGroupListPage(para).then((res) => {
