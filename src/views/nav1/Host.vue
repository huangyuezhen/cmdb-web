    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item>
                    <el-autocomplete v-model="filters.application_name" :fetch-suggestions="queryAppSearchAsync" placeholder="应用名称" @select="handleSelect"></el-autocomplete>
                </el-form-item>
                <el-form-item>
                    <el-autocomplete v-model="filters.business_group_name" :fetch-suggestions="querySearchAsync" placeholder="业务组名称" @select="handleSelect"></el-autocomplete>
                </el-form-item>
                <el-form-item>
        ...
        <!--列表-->
        <el-table :data="applications" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="agent_status" label="agent 状态" width="150" :filters="[{ text: '正常', value: 1 }, { text: '异常', value: 2 },{text:'下架',value:3},{text:'未安装',value :4}]" :filter-method="filterTag" filter-placement="bottom-end">
            ...
            <el-table-column prop="status" label="状态" width="150" :filters="[{ text: '库存', value: 0 }, { text: '上架', value: 1 },{text:'初始化',value:2},{text:'故障',value :3},{text:'下线',value:4}]" :filter-method="filterStatusTag" filter-placement="bottom-end">
                <template scope="scope">
